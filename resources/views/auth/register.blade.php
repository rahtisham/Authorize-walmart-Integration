...
<x-guest-layout>
    ...
    <div class="container py-3">
        <div class="row">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-div">
                        <div class="form-group">
                            <x-jet-input id="email" class="form-control email-form" type="email" name="email" placeholder="Enter Email" :value="old('name')" autofocus autocomplete="name" />
                            @error('email')
                        ...
                        <div class="form-group" style="display: flex;">
                            <x-jet-input type="text" name="name" placeholder="First Name" class="form-control fname name-form" :value="old('name')" autofocus autocomplete="name"/>
                            @error('name')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                            <x-jet-input type="text" id="last_name" name="last_name" placeholder="Last Name" class="form-control lname name-form" :value="old('last_name')" autofocus autocomplete="last_name"/>
                            @error('name')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group" style="display: flex;">
                            <x-jet-input type="text" id="postal" name="postal" placeholder="Postcode / Zip" class="form-control name-form" :value="old('postal')" autofocus autocomplete="postal" />
                            @error('postal')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            <x-jet-input type="tel" id="contact" name="contact" placeholder="Phone (Optional)" class="form-control name-form" :value="old('contact')" autofocus autocomplete="contact"  />
                            @error('contact')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <x-jet-input type="password" id="password_confirmation" name="password_confirmation" placeholder="password_confirmation" class="form-control name-form" autocomplete="new-password" />
                            @error('name')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="container py-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="cardNumber" name="cardNumber" placeholder="1234 1234 1234 1234" class="form-control card-num name-form" value="{{ old('cardNumber') }}">
                                    @error('cardNumber')
                                    <span class="text-danger"> {{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6 py-3">
                                    ...
                                    <input type="text" id="cvv" name="cvv" placeholder="CVC" class="form-control lname card-cvc name-form" value="{{ old('cvv') }}" >
                                    @error('cvv')
                                    <span class="text-danger"> {{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6 py-3">
                                    ...
                                    <input type="text" id="amount" name="amount" placeholder="Amount" class="form-control fname card-exp name-form" min="1" value="{{ old('amount') }}" >
                                    @error('amount')
                                    <span class="text-danger"> {{ $message }}</span>
                                    @enderror
                                </div>
            ...
            <div class="col-md-5"></div> <!-- end of col-md-5 -->
        </div> <!--end of row -->
